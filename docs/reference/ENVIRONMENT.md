...
| `OMNIROUTE_DEBUG_ANTIGRAVITY_TIER`        | `false`                    | Opt-in sanitized Antigravity tier diagnostics. Logs subscription tier fields only; never logs tokens, headers, or full payloads. |
